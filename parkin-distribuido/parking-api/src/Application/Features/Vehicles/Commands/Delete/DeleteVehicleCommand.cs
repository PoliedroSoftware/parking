...
// Command and handler for deleting Vehicle entities.
...
public class DeleteVehicleCommand:  ICacheInvalidatorRequest<Result>
{
  public int[] Id {  get; }
...

{
    ...
    public async Task<Result> Handle(DeleteVehicleCommand request, CancellationToken cancellationToken)
    {
        ...
        var items = await db.Vehicles.Where(x=>request.Id.Contains(x.Id)).ToListAsync(cancellationToken);
