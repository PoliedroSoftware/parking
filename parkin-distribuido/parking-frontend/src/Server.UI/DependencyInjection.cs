...
#pragma warning restore 0618
        ...
        services.Configure<ParkingApiOptions>(config.GetSection(ParkingApiOptions.SectionName));
        services.AddHttpClient<ParkingApiClient>((serviceProvider, client) =>
        {
            var options = serviceProvider.GetRequiredService<IOptions<ParkingApiOptions>>().Value;
