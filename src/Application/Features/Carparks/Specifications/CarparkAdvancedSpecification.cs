...
//       Carpark entity, supporting different views and keyword-based searches.
// </auto-generated>
//------------------------------------------------------------------------------
#nullable enable
...
#nullable disable warnings
/// <summary>
/// Specification class for advanced filtering of Carparks.
/// </summary>
public class CarparkAdvancedSpecification : Specification<Carpark>
{
    public CarparkAdvancedSpecification(CarparkAdvancedFilter filter)
    {
        ...
        Query.Where(q => q.Name != null)
             ...
             .Where(x => x.CreatedAt >= last30daysrange.Start, filter.ListView == CarparkListView.LAST_30_DAYS);
